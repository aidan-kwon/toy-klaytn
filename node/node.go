...
import (
	...
	"github.com/aidan-kwon/toy-klaytn/networks/grpc"
...
func New(conf *Config) (*Node, error) {
	...
	// TODO: account manager will be implemented later
...
func (n *Node) Start() error {
	...
	n.logger.Info("Starting peer-to-peer node", )
...
func (n *Node) initService(serviceFunc []ServiceConstructor, services map[reflect.Type]Service) error {
	for _, constructor := range serviceFunc {
		...
		ctx := NewServiceContext(n.config, make(map[reflect.Type]Service))
